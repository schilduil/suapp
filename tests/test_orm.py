...
def orm_objects(pony_entity_object):
    ...
    test.ui_init()
    setattr(
        sys.modules[pony_entity_object.__class__.__module__], "UiTestOrm", UiTestOrm
    )
    setattr(
        sys.modules[pony_entity_object.__class__.__module__],
        "UiSubTestOrm",
        UiSubTestOrm,
    )
...
def test_uize(orm_objects):
    (pony_entity_object, ui_orm_object) = orm_objects
    assert suapp.orm.UiOrmObject.uize(
        pony_entity_object
    ).__class__.__name__ == "Ui%s" % (pony_entity_object.__class__.__name__)
